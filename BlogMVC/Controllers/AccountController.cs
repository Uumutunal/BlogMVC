...
namespace BlogMVC.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(string email, string password)
        {
            ...
            var login = await _httpClient.PostAsJsonAsync("https://blogy1.azurewebsites.net/api/Account/Login", user);
        ...
        public async Task<IActionResult> Register(string username, string email, string password, string confirmPassword, IFormFile photo, string firstname, string lastname)
        {
            ...
            var register = await _httpClient.PostAsJsonAsync("https://blogy1.azurewebsites.net/api/Account/Register", user);
        ...
        public async Task<IActionResult> Profile()
        {
            ...
            var loggedUser = await _httpClient.GetAsync($"https://blogy1.azurewebsites.net/api/Account/user?id={loggedUserId}");
        ...
        public async Task<IActionResult> Profile(UserViewModel user, IFormFile image)
        {
            ...
            var result = await _httpClient.PutAsJsonAsync("https://blogy1.azurewebsites.net/api/Account/Update", userUpdate);
        ...
        public async Task<IActionResult> DeleteAccount()
        {
            ...
            var user = await _httpClient.GetAsync($"https://blogy1.azurewebsites.net/api/Account/user?id={userId}");
            ...
            var result = await _httpClient.PostAsync($"https://blogy1.azurewebsites.net/api/Account/DeleteAccount?id={userId}", null);
        ...
        public async Task<IActionResult> FollowUser(string authorId, Guid postId)
        {
            ...
            var followUser = await _httpClient.PostAsJsonAsync("https://blogy1.azurewebsites.net/api/Account/Follow", follower);
        ...
        public async Task<IActionResult> UnFollowUser(string authorId, Guid postId)
        {
            ...
            var followUser = await _httpClient.PostAsJsonAsync("https://blogy1.azurewebsites.net/api/Account/UnFollow", followers.Id);
